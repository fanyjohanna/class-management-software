...
class ClassroomsController extends Controller
{
    ...
    public function update(Request $request, Classroom $classroom)
    {
        ...
        return redirect('/classrooms')->with('success', 'You have updated classroom successfully ! ');
    }
    ...
    public function destroy(Classroom $classroom)
    {
        // return $classroom;
        $classroom->delete();
        return redirect('/classrooms')->with('success', 'You have success delete Classroom');
    }
}
